...
export default function Home() {
  ...
  const handleGetRequest = async () => {
    const res = await fetch('http://tech0-gen-8-step3-app-py-14.websites.net/api/hello', {
      method: 'GET',
    });
  ...
  const handleIdRequest = async (e) => {
    ...
    const res = await fetch(`http://tech0-gen-8-step3-app-py-14.websites.net/api/multiply/${id}`, {
      method: 'GET',
    });
    const data = await res.json();
  ...
  const handleSubmit = async (e) => {
    ...
    const res = await fetch('http://tech0-gen-8-step3-app-py-14.websites.net/api/echo', {
      method: 'POST',
      headers: {
